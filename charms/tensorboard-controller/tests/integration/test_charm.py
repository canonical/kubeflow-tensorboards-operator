...
istio_gw = SimpleNamespace(charm="ch:istio-gateway", name="istio-ingressgateway", channel="latest/edge", config={"kind": "ingress"})
istio_pilot = SimpleNamespace(charm="ch:istio-pilot", name="istio-pilot", channel="latest/edge", config={"default-gateway": "test-gateway"})
